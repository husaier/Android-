...
public class Exercises3 extends AppCompatActivity implements MyAdapter.ListItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        header.setBackgroundColor(ColorUtils.
                getViewHolderBackgroundColorFromInstance(context,18));
        ...
        /*
         * The MyAdapter is responsible for displaying each item in the list.
         */
    ...
    public void onListItemClick(int clickedItemIndex) {
        ...
        String msg = "ViewHolder index: " + clickedItemIndex;
